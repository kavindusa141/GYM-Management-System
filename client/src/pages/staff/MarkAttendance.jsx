...
import { 
  CheckCircle, Clock, Activity, Search, AlertCircle, LogOut, Timer, QrCode, User
} from 'lucide-react';
...
export default function StaffMarkAttendance() {
  ...
  const [qrPayload, setQrPayload] = useState(''); // Added QR State
  ...
  // 2. Fetch QR Payload (New Function for Staff)
  const fetchQR = async () => {
    try {
