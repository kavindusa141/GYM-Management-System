...
export default function PointOfSale() {
  ...
  const handleProcessPayment = async () => {
    ...
    try {
      ...
      const response = await api.post('/payments/admin-pay', formData, {
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 shrink-0">
        ...
        <div className="flex bg-white p-1 rounded-xl border border-gray-200 shadow-sm">
          <button
            ...
            className={`px-6 py-2.5 text-sm font-bold rounded-lg transition-all flex items-center gap-2 ${activeTab === 'POS'
                    ...
                    {filteredMembers.length === 0 ? (
                      ...
                      filteredMembers.map(member => (
                        <div
                          ...
                          className={`p-3 px-4 cursor-pointer flex justify-between items-center transition-all border-b border-gray-50 last:border-0 ${selectedMember?.user_id === member.user_id
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {plans.map(plan => (
                  <div
                    ...
                    className={`rounded-xl border cursor-pointer transition-all overflow-hidden flex flex-col ${selectedPlan?.plan_id === plan.plan_id
          ...
          <div className="bg-slate-900 text-white p-8 rounded-3xl shadow-2xl flex flex-col h-full">
            ...
            <div className="mt-6 pt-6 border-t border-slate-700 shrink-0">
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 transition-all ${processing || !selectedMember || !selectedPlan
